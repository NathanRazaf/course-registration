...
public class Server {
    ...
    public void handleRegistration() {
        try {
            ...
            String message = "\u001B[32mFélicitations ! Inscription réussie de " + registrationForm.getPrenom() +
        ...
        fichier inscription.txt ou dans le flux de sortie. */
            ...
            try {
                objectOutputStream.writeObject("\u001B[31mUne erreur est survenue. Échec de l'inscription...\u001B[0m");
